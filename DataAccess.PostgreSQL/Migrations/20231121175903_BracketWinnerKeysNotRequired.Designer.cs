...
namespace DataAccess.PostgreSQL.Migrations
{
    ...
    [Migration("20231121175903_BracketWinnerKeysNotRequired")]
    partial class BracketWinnerKeysNotRequired
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataAccess.Domain.Models.BracketWinner", b =>
                {
                    b.HasOne("DataAccess.Domain.Models.Fighter", "FirstPlacePlayer")
                        .WithOne()
                        .HasForeignKey("DataAccess.Domain.Models.BracketWinner", "FirstPlaceId");

                    b.HasOne("DataAccess.Domain.Models.Bracket", "Bracket")
                        .WithOne()
                        .HasForeignKey("DataAccess.Domain.Models.BracketWinner", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DataAccess.Domain.Models.Fighter", "SecondPlacePlayer")
                        .WithOne()
                        .HasForeignKey("DataAccess.Domain.Models.BracketWinner", "SecondPlaceId");

                    b.HasOne("DataAccess.Domain.Models.Fighter", "ThirdPlacePlayer")
                        .WithOne()
                        .HasForeignKey("DataAccess.Domain.Models.BracketWinner", "ThirdPlaceId");
