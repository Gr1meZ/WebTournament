...
namespace WebTournament.Presentation.MVC.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class LoginModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [EmailAddress(ErrorMessage = "Логин не прошел валидацию")]
            ...
            if (ModelState.IsValid)
            {
                ...
                else
                {
                    ...
                    var list = new List<IdentityError>
                    {
                        ...
                        {
                            Code = String.Empty,
                            Description = "Неверная попытка входа."
                        }
                    };
                    ViewData["Errors"] = list;
                    return Page();
                }
            }
